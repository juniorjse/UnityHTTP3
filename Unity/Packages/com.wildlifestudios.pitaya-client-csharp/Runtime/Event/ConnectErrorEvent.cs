...
{
    public class ConnectErrorEvent : INetworkEvent
    {
        public string Arg1 { get; } // reason description
        public string Arg2 { get; }
        public ConnectErrorEvent(string reason, string arg2 = null)
        {
            Arg1 = reason;
            Arg2 = arg2;
        }
        ...
        public override string ToString() { return "PC_EV_CONNECT_ERROR"; }
    }
}