...
namespace Wildlife.PitayaCSharp.Client
{
    ...
    {
        readonly Dictionary<uint, Action<byte[]>> _callBackMap;
        readonly Dictionary<uint, Action<PitayaError>> _errorCallBackMap;
        readonly Dictionary<string, List<Action<byte[]>>> _eventMap;
        ...
        private void Dispose(bool disposing)
        {
            ...
            foreach (var callback in errorCallBackMap)
                callback.Value.Invoke(new PitayaError("PIT-LIB-INT", "pitaya-csharp exited"));
